    ...
    <div className='flex justify-center h-[50px] w-[80%] md:order-[2] md:max-w-[84px]'>
      <div className='h-full w-[70%] relative'>
        ...
        <span
          ...
          onClick={handleClick}
        ></span>
        <FiSearch className='absolute right-4 md:left-[50%] bottom-[50%] translate-y-[50%] md:translate-x-[-50%] text-2xl md:text-4xl xl:text-[2rem] xl:font-bold md:w-full md:text-white' />
      </div>
